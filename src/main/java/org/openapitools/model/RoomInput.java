...
public class RoomInput {
  ...
  @Schema(name = "name", example = "Conference Room", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
  ...
  @Schema(name = "description", example = "A room used for meetings", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
